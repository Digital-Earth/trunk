...
namespace PyxNet.Test
{
    ...
    public class StackConnectionResponseTests
    {
        /// <summary>
        ...
        public void Test()
        {
            ...
            // Create an object.
            StackConnectionResponse original = new StackConnectionResponse(
                false, fromNode, khl);
            original.Error = StackConnectionResponse.ErrorType.IncorrectNode;

            // Convert it to a message.
            Message message = original.ToMessage();

            // Construct a new one from the message.
            StackConnectionResponse reconstructed = new StackConnectionResponse(message);
            ...
            NUnit.Framework.Assert.IsTrue(original.Error == reconstructed.Error);
        }
    }
}