/******************************************************************************
GenerateReportMessage.cs

begin      : November 17, 2009
...
{
    public class GenerateReportMessage : GeoStreamServerMessage
    {
        public const string MessageID = "GSgr";
        ...
        {
            return "GeoStream-GenerateReport";
        }
