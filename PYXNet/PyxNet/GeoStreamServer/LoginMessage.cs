...
{
    public class LoginMessage : GeoStreamServerMessage
    {
        public const string MessageID = "GSli";
        ...
        public override void FromMessageReader(MessageReader reader)
        {
            ...
            Username = reader.ExtractUTF8();
            Password = reader.ExtractUTF8();
            Success = reader.ExtractBool();
