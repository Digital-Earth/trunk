    ...
    public static class TestData
    {
        ...
        public static string CreateRandomFile(string directoryName)
        {
            ...
            using (FileStream fs = new FileStream(fileName, FileMode.CreateNew))
            {
                ...
                {
                    writer.Write(PyxNet.Test.TestData.GenerateBytes(
                        PyxNet.Test.TestData.GenerateInt(32000)));
                }
            }
        ...
        {
            for (int fileCount = PyxNet.Test.TestData.GenerateInt(5);
                fileCount > 0;
                --fileCount)
            {
        ...
        public static PyxNet.Utilities.TemporaryDirectory CreateRandomTemporaryDirectory()
        {
            return new PyxNet.Utilities.TemporaryDirectory(CreateRandomDirectory());
        }
