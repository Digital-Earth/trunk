...
namespace Pyxis.IO.DataSet
{
    ...
    /// </summary>
    public class DataSetCatalogModel
    {
        /// <summary>
        ...
        public static DataSetCatalogModel Create(IDataSetCatalog catalog)
        {
            if (catalog == null)
            {
                ...
                return new DataSetCatalogModel();
            }
            // Copy the properties
            var result = new DataSetCatalogModel
            {
                Type = ResourceType.Catalog.ToString(),
                DataType = catalog.DataType.ToString(),
                Uri = catalog.Uri ?? "",
            ...
            {
            case Pyxis.IO.DataSet.DataType.Local:
