#ifndef area_style_feature_collection_process_H
#define area_style_feature_collection_process_H
/******************************************************************************
area_style_feature_collection_process.h
...
Output: Area Styled Feature Collection
*/
//! Applies a user-specified area style to a feature collection.
class MODULE_FEATURE_PROCESSING_PROCS_DECL AreaStyleFeatureCollectionProcess : 
	public ProcessImpl<AreaStyleFeatureCollectionProcess>, public IFeatureCollection
{
...
public:
	...
	//! Constructor
	AreaStyleFeatureCollectionProcess();
...
public: // PYXCOM_IUnknown
	...
	IUNKNOWN_DEFAULT_CAST(AreaStyleFeatureCollectionProcess, IProcess);
...
public :
	...
	static const std::string kstrAreaColour;
