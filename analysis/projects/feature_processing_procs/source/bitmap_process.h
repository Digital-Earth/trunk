...
/*!
a Bitmap Process that loads a bitmap from a given IPath.
*/
//! a Bitmap Process that loads a bitmap from a given IPath.
class MODULE_FEATURE_PROCESSING_PROCS_DECL BitmapProcess : public ProcessImpl<BitmapProcess>, public IBitmap
{
