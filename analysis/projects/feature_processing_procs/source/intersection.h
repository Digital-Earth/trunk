#ifndef FEATURE_PROCESSING_PROCS__INTERSECTION_H
#define FEATURE_PROCESSING_PROCS__INTERSECTION_H
...
class MODULE_FEATURE_PROCESSING_PROCS_DECL Intersection : public ProcessImpl<Intersection>, public IFeatureCollection
{
