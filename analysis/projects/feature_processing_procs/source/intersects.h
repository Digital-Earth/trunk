#ifndef FEATURE_PROCESSING_PROCS__INTERSECTS_H
#define FEATURE_PROCESSING_PROCS__INTERSECTS_H
...
class MODULE_FEATURE_PROCESSING_PROCS_DECL Intersects : public ProcessImpl<Intersects>, public IFeatureCollection
{
...
private:
	...
	static bool match(const PYXGeometry& aoiGeometry, boost::intrusive_ptr<IFeature> spFeature)
	{
		...
		return spGeometryToCheck && aoiGeometry.intersects(*spGeometryToCheck);
	}
