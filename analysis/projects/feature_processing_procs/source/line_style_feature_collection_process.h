#ifndef line_style_feature_collection_process_H
#define line_style_feature_collection_process_H
/******************************************************************************
line_style_feature_collection_process.h
...
Output: Lin Styled Feature Collection
*/
//! Applies a user-specified line style to a feature collection.
class MODULE_FEATURE_PROCESSING_PROCS_DECL LineStyleFeatureCollectionProcess : 
	public ProcessImpl<LineStyleFeatureCollectionProcess>, public IFeatureCollection
{
...
public:
	...
	//! Constructor
	LineStyleFeatureCollectionProcess();
...
public: // PYXCOM_IUnknown
	...
	IUNKNOWN_DEFAULT_CAST(LineStyleFeatureCollectionProcess, IProcess);
...
public :
	...
	//! The attribute name for use in Process Editor.
	static const std::string kstrLineWidth;
