#ifndef RGB_TO_VALUE_PROCESS_H
#define RGB_TO_VALUE_PROCESS_H
/******************************************************************************
...
*/
//! Process that transform values of a coverage using a transform mapping table.
class MODULE_IMAGE_PROCESSING_PROCS_DECL RgbToValueProcess : public ProcessImpl<RgbToValueProcess>, public CoverageBase
{
...
private:
	...
	int colorDistance(const unsigned char * a,const unsigned char * b) const;
