#ifndef BICUBIC_SAMPLER__WITH_NULLH
#define BICUBIC_SAMPLER__WITH_NULLH
/******************************************************************************
bicubic_sampler_with_null.h
...
class MODULE_SAMPLING_DECL BicubicSamplerWithNull : public ProcessImpl<BicubicSamplerWithNull>, public SamplerBase
{
...
public: // implementation
	...
	BicubicSamplerWithNull()
	{
		m_strID = "Bicubic Sampler with Null: " + procRefToStr(ProcRef(getProcID(), getProcVersion()));
	}
...
private:
	...
	bool tryFillNulls(  PYXValue * values, int offsetX, int offsetY) const;
