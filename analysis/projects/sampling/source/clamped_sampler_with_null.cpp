...
// {E414C479-4E9A-423F-AA17-6ABF54967705}
PYXCOM_DEFINE_CLSID(ClampedSamplerWithNull, 
0xe414c479, 0x4e9a, 0x423f, 0xaa, 0x17, 0x6a, 0xbf, 0x54, 0x96, 0x77, 0x5);

PYXCOM_CLASS_INTERFACES(ClampedSamplerWithNull, IProcess::iid, ICoverage::iid, IFeature::iid, PYXCOM_IUnknown::iid);

IPROCESS_SPEC_BEGIN(ClampedSamplerWithNull, "Standard Sampler With Null", 
...
ClampedSamplerWithNull::ClampedSamplerWithNull() :
...
*/
bool ClampedSamplerWithNull::getCoverageValue(	const PYXIcosIndex& index,
												PYXValue* pValue,
...
*/
PYXPointer<PYXValueTile> ClampedSamplerWithNull::getFieldTile(const PYXIcosIndex& index,
												   int nRes,
												   int nFieldIndex) const
{
...
bool ClampedSamplerWithNull::generateCoverageValue(const PYXIcosIndex & index,
...
*/
boost::intrusive_ptr<SamplerBase> CreateSampler1( CLSID samplerClassId, boost::intrusive_ptr<IProcess> input)
{
	// Create a sampler
...
*/
int ClampedSamplerWithNull::getNativeResolution() const
{
	if (m_nativeResolution == -1)
	{
		...
		m_spOverSampler = CreateSampler1( 
			BicubicSamplerWithNull::clsid, getParameter(0)->getValue(0));
		m_spUnderSampler = CreateSampler1( 
