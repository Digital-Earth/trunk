...
namespace ManifestCreator
{
    ...
    {
        private static TraceTool Trace = new TraceTool( false);
        ...
        private IEnumerable<ManifestEntry> GetFileInfo(string relativeDir)
        {
            ...
            foreach (FileInfo file in currentDirectory.GetFiles())
            {
                ...
                {
                    yield return new ManifestEntry(file, relativeDir, ForceSynchronousCheckSums);
                }
            }
            ...
            {
                foreach (ManifestEntry file in GetFileInfo(relativeDir + dirSeparator + subDir.Name))
                {
                    yield return file;
                }
            }
        ...
        private Manifest GenerateManifest()
        {
            ...
            foreach (ManifestEntry file in GetFileInfo(""))
            {
