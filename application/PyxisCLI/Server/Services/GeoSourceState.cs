...
namespace PyxisCLI.Server.Services
{
    internal class GeoSourceState : IGeoSourceState
    {
        ...
        private async Task<Style> DoGetStyle()
        {
            ...
            {
                var styledGeoSource = StyledGeoSource.Create(Program.Engine, geoSource);
        ...
        {
            var geoSource = await GetGeoSource();
            var styledGeoSource = StyledGeoSource.Create(Program.Engine, geoSource, styleRequest.Style);
        ...
        private async Task<PipelineSpecification> DoGetSpecification()
        {
            ...
            return Cache.GeoSourceBlobCacheSingleton.GetOrGenerateMetadata(geoSource, Program.Engine.GetSpecification);
        }
