...
namespace PyxisCLI.Utilities
{
    ...
    class GeoTagMethodFinder
    {
        ...
        public GeoTagMethodFinder(ProvideGeoTagImportSettingArgs args, string srs = null)
        {
            Args = args;
            Srs = srs;
        }

        public List<IGeoTagMethod> FindGeoTagOptions()
        {
            ...
            var result = new List<IGeoTagMethod>();
        ...
        /*
        private IEnumerable<IGeoTagMethod> FindLookupFields(IRecordCollection_SPtr recordCollection, RecordCollectionSample sample)
        {
        ...
        */
        ...
        private IEnumerable<IGeoTagMethod> FindLatLonFields(IRecordCollection_SPtr recordCollection, RecordCollectionSample sample)
        {
        ...
        private IEnumerable<IGeoTagMethod> FindLatLonFields(List<string> fieldNames, string latitudeName, string longitudeName)
        {            
            var prefixes = 
            ...
            {
                yield return new GeoTagByLatLonPoint()
                {
        ...
        private SpatialReferenceSystem CreateReferenceSystem()
        {
            return Srs.HasContent() ? SpatialReferenceSystem.CreateFromWKT(Srs) : SpatialReferenceSystem.WGS84;
        }
    }
}
