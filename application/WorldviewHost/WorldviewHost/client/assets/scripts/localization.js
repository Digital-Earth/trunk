...
//based on: https://github.com/zeflasher/angularjs-i18n
        ...
        function ($http, $rootScope, $window) {
            var localize =
            {
                ...
                initLocalizedResources: function () {
                    ...
                    .success(localize.setStringTable)
                    .error
                    (
                        function () {
                ...
                replaceAttribute: function (elm, attr, str) {
                    var tag = localize.getLocalizedString(str);
                    //  update the element only if data was returned
                    if ((tag !== null) && (tag !== undefined) && (tag !== '')) {
                        //  insert the text into the element
        ...
        function (localize) {
            return {
                ...
                link: function (scope, elm, attrs) {
                    var str = attrs.i18n ? attrs.i18n : elm.text();
    ...
    [
        ...
        function (localize) {
            return {
                restrict: "EAC",
                link: function (scope, elm, attrs) {
                    var str = attrs.i18nPlaceholder;

                    if (localize.resourceFileLoaded) {
                        localize.replaceAttribute(elm, 'placeholder', str);
                    }
                    else {
                        deregister = scope.$on('localizeResourcesUpdates',
                        function () {
