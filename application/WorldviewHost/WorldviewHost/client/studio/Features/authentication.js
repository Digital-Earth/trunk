app.service("featureAuthentication", function ($pyx, $filter, $pyxconfig, $q, $timeout, $interval, $window, $pyxIntercom, worldViewStudioConfig, siteParams,
    ...
    function register($scope, options) {
        ...
        $scope.addTemplate('dialogs', '/client/templates/studio/template/feature-authentication.html');
        ...
        $pyx.application.ready(function () {
            $timeout(function () {
                ...
                */
                ...
                studioSetupCompleted = false;
                var initStudioSetup = function () {
                    //inforce running init only once
                    if (studioSetupCompleted) {
                        return;
                    }
                ...
                */
                ...
                $scope.authenticateUser = function() {
                    ...
                    if (!$pyx.user.auth()) {
                        ...
                        */
                        ...
                        $scope.loginService = $pyx.user.loginService($pyx, i18n, onLoginComplete, onError, true, window.location.pathname, handlePostRedirect);
                ...
                if ("fileDragDrop" in $pyx.application && $scope.activeFeatures.dragAndDrop) {
                    ...
                    $pyx.application.fileDragDrop(function (files) {
                        $timeout(function () {
                            $pyxIntercom.track('drag-and-drop-file');
