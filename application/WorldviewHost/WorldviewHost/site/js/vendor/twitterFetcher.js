      ...
      while(n < x) {
          ...
          if (printTime) {
            if (permalinks) {
              ...
              //    '">' + times[n].getAttribute('aria-label') + '</a></p>';
                 op += '<hr class="hr-delimiter" text="' + times[n].getAttribute('aria-label') + '"></hr>';
            } else {
                op += '<hr class="hr-delimiter" text="' + times[n].getAttribute('aria-label') + '"></hr>';
            }
          }
        ...
        if (showInteractionLinks) {
          op += '<p class="interact"><a href="https://twitter.com/intent/' +
              ...
              tids[n] + '" class="twitter_retweet_icon link link--normal"' +
              (targetBlank ? ' target="_blank">' : '>') + 'Retweet</a>' +
              '<a  class="link link--normal"  href="https://twitter.com/intent/favorite?tweet_id=' +
