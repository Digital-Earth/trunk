app.controller('worldviewFaqController', function ($scope, $pyx, $location) {
    $scope.faqs = [
        ...
        },
        {
            ...
            "qaPairs": [
                {
                    "question": "Is there a limit to how many Globes or GeoSources I can use?",
                    "answer": "No. You can import and use as many GeoSources and Globes as you like."
                },
                {
                    "question": "Is there a limit to how many Globes or GeoSources I can share?",
