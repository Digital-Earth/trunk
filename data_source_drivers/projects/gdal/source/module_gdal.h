#ifndef MODULE_GDAL_H
#define MODULE_GDAL_H
/******************************************************************************
module_gdal.h
...
#ifndef SWIG
#   define MODULE_GDAL_HAS_DECLSPEC
#endif

#ifdef MODULE_GDAL_HAS_DECLSPEC // defined in config system
	/*
	...
	*/
#	if !defined(MODULE_GDAL_STATIC_LINK)
		// Export if this is our own source, otherwise import:
#		ifdef MODULE_GDAL_SOURCE
#			define MODULE_GDAL_DECL __declspec(dllexport)
#		else
#			define MODULE_GDAL_DECL __declspec(dllimport)
...
#ifndef MODULE_GDAL_DECL
#	define MODULE_GDAL_DECL
#endif

// TODO make this more like boost mechanism
#if !defined(MODULE_GDAL_SOURCE)
#	pragma comment(lib, "gdal_data_source.lib")
#endif
