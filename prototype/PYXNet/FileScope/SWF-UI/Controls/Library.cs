	...
	public class Library : System.Windows.Forms.UserControl
	{
		...
		public void UpdateShares()
		{
			...
			try
			{
				...
				{
					foreach(string sharedDir in Configuration.shareList)
					{
						string lastSubDir;
		...
		private void listViewFiles_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				FileObject fo = (FileObject)Configuration.fileList[fileID];
		...
		void MoveFile()
		{
			try
			{
				...
				if(strFolder.Length == 0)
					return;
				Configuration.suppressUpdate = true;
				...
				Configuration.suppressUpdate = false;
				Configuration.UpdateShares();
			}
			catch
			{
