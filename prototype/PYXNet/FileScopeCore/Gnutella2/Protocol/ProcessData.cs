...
namespace FileScopeCore.Gnutella2
{
    ...
    public class G2Data
    {
        ...
        public static void HandlePing(Message msg)
        {
            Ping ping = (Ping)msg;
            ping.Read(0);
            Configuration.State.Gnutella2Stats.numPI++;
        }
        ...
        public static void HandlePong(Message msg)
        {
            Pong pong = (Pong)msg;
            pong.Read(0);
            Configuration.State.Gnutella2Stats.numPO++;
        }
        ...
        public static void HandleLNI(Message msg)
        {
            ...
            lni.Read(0);
            Configuration.State.Gnutella2Stats.numLNI++;
        }
        ...
        public static void HandleKHL(Message msg)
        {
            ...
            khl.Read(0);
            Configuration.State.Gnutella2Stats.numKHL++;
        }
        ...
        public static void HandlePush(Message msg)
        {
            Push push = (Push)msg;
            push.Read(0);
            Configuration.State.Gnutella2Stats.numPUSH++;
        }
        ...
        public static void HandleQHT(Message msg)
        {
            ...
            Configuration.State.Gnutella2Stats.numQHT++;
        }
        ...
        public static void HandleQKR(Message msg)
        {
            ...
            qkr.Read(0);
            Configuration.State.Gnutella2Stats.numQKR++;
        }
        ...
        public static void HandleQKA(Message msg)
        {
            ...
            qka.Read(0);
            Configuration.State.Gnutella2Stats.numQKA++;
        }
        ...
        public static void HandleQuery(Message msg)
        {
            ...
            query.Read(0);
            Configuration.State.Gnutella2Stats.numQ2++;
        }
        ...
        public static void HandleQueryAck(Message msg)
        {
            ...
            qa.Read(0);
            Configuration.State.Gnutella2Stats.numQA++;
        }
        ...
        public static void HandleQueryHit(Message msg)
        {
            ...
            qh.Read(0);
            Configuration.State.Gnutella2Stats.numQH2++;
        }
