...
namespace FileScopeCore
{
    ...
    public class IPfilter
    {
        ...
        {
            if (ip.IndexOf(Configuration.settings.ipAddress) != -1)
            {
                return true;
            }
            ...
            try
            {
                ...
                if (bytesIP[0] == (byte)172 && bytesIP[1] >= (byte)16 && bytesIP[1] <= (byte)31)
                {
                    return true;
                }
                if (bytesIP[0] == (byte)192 && bytesIP[1] == (byte)168)
                {
                    return true;
                }
                if (bytesIP[0] == (byte)127 && bytesIP[1] == (byte)0)
                {
                    return true;
                }
                if (bytesIP[0] == (byte)0 && bytesIP[1] == (byte)0 && bytesIP[2] == (byte)0 && bytesIP[3] == (byte)0)
                {
                    return true;
                }
                return false;
