#pragma once
#ifndef PYXLIB__RHOMBUS_BITMAP_H
#define PYXLIB__RHOMBUS_BITMAP_H
/******************************************************************************
rhombus_bitmap.h
...
RGB16BitConstAlphaColorizer - convert 16bit pixels to 8bit, copy the PYXValue as uint16[3] and add a constant alpha
*/
class RGBFloat32ConstAlphaColorizer : public IColorizer
{
protected:
	unsigned char m_alpha;
	float m_min;
	...
	unsigned char transform(float number) const;

public:
	RGBFloat32ConstAlphaColorizer(float min = 0, float max = 10000, unsigned char alpha = 255);
