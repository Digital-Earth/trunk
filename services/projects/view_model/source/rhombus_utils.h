#pragma once
#ifndef VIEW_MODEL__RHOMBUS_UTILS_H
#define VIEW_MODEL__RHOMBUS_UTILS_H
/******************************************************************************
rhombus_utils.h
...
*/
class VIEW_MODEL_API PYXRhombusUtils
{
public:
...
class VIEW_MODEL_API PYXRhombusRasterizer : public PYXObject
{
private:
