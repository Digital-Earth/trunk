#region File Header
//
//      FILE:   DataRelationChildEditor.cs.
//
...
namespace Infralution.Controls.VirtualTree.Design
{
    ...
    /// <summary>
    /// Defines the <see cref="UITypeEditor"/> for editing child relation names for 
    /// a <see cref="DataRowRowBinding"/>
    /// </summary>
    internal class DataRelationChildEditor : Infralution.Controls.ListUITypeEditor  
    {
        ...
        { 
            ...
            return new ArrayList(table.ChildRelations);
        }
