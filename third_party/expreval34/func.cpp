...
namespace
	...
	// Average
    //--------------------------------------------------------------------------
    class avg_FunctionNode : public FunctionNode
        {
        public:
            avg_FunctionNode::avg_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
            ...
            double DoEvaluate()
                ...
                double sum = m_nodes[0]->Evaluate();
                
                for(pos = 1; pos < m_nodes.size(); pos++)
                    {
                    sum += m_nodes[pos]->Evaluate();
                    }
    ...
    class avg_FunctionFactory : public FunctionFactory
        {
        public:
            string GetName() const
                {
            ...
            FunctionNode *DoCreate(Expression *expr)
                {
                return new avg_FunctionNode(expr);
                }
        };

	// Average
    //--------------------------------------------------------------------------
    class stddev_FunctionNode : public FunctionNode
        {
        public:
            stddev_FunctionNode::stddev_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, -1, 0, 0);
                }
            ...
            double DoEvaluate()
                ...
                return sqrt(sum2/m_nodes.size()-pow(sum/m_nodes.size(),2));
                }
        };
        
    class stddev_FunctionFactory : public FunctionFactory
        {
        public:
            string GetName() const
                {
            ...
            FunctionNode *DoCreate(Expression *expr)
                {
                return new stddev_FunctionNode(expr);
                }
        };
    ...
    class pow_FunctionNode : public FunctionNode
        {
        public:
            pow_FunctionNode::pow_FunctionNode(Expression *expr) : FunctionNode(expr)
                {
                SetArgumentCount(2, 2, 0, 0);
                }
