...
// Constructor
BinaryOperandNode::BinaryOperandNode(Expression *expr) : Node(expr), m_lhs(0), m_rhs(0)
    {
    }
    
// Destructor
BinaryOperandNode::~BinaryOperandNode()
    {
    // Free child nodes
    delete m_lhs;
    delete m_rhs;
...
// Evaluate
double BinaryOperandNode::DoEvaluate()
    {
    return Perform(m_lhs->Evaluate(),m_rhs->Evaluate());
    }
    
// Parse
void BinaryOperandNode::Parse(Parser &parser, Parser::size_type start, Parser::size_type end,
        Parser::size_type v1)
    {
    // Check some basic syntax
    if(v1 <= start || v1 >= end)
...
// Add node
//--------------------------------------------------------------------------
double AddNode::Perform(double left,double right) { 
	return left + right; 
}
    
// Subtract node
//--------------------------------------------------------------------------
double SubtractNode::Perform(double left,double right) { 
	return left - right;
}

// Multiply node
//-------------------------------------------------------------------------- 
double MultiplyNode::Perform(double left,double right) { 
	return left * right; 
}
        
// Divide node
//--------------------------------------------------------------------------    
double DivideNode::Perform(double left,double right) { 
	if (right != 0.0)
	{
		return left / right; 
	}
...
// Compare Equal node
//--------------------------------------------------------------------------    
double CompareEqualNode::Perform(double left,double right) { 
	if (left == right)
	{
		return 1.0; 
	}
...
//--------------------------------------------------------------------------
double CompareSmallerNode::Perform(double left,double right) { 
	if (left < right)
	{
		return 1.0; 
	}
...
//--------------------------------------------------------------------------
double CompareGreaterNode::Perform(double left,double right) { 
	if (left > right)
	{
		return 1.0; 
	}
...
//--------------------------------------------------------------------------
double CompareSmallerEqualNode::Perform(double left,double right) { 
	if (left <= right)
	{
		return 1.0; 
	}
...
//--------------------------------------------------------------------------
double CompareGreaterEqualNode::Perform(double left,double right) { 
	if (left >= right)
	{
		return 1.0; 
	}
...
// Logical And node
//--------------------------------------------------------------------------
double LogicalAndNode::Perform(double left,double right) { 
...
// Logical Or node
//--------------------------------------------------------------------------
double LogicalOrNode::Perform(double left,double right) { 
	if (left != 0.0 || right != 0.0)
	{
		return 1.0; 
	}
...
void VariableNode::Parse(Parser &parser, Parser::size_type start, Parser::size_type end,
    ...
    // BR: commented this out to avoid the creation of new variables so that expression entry can be validated.
    //if(vaddr == 0)
    //    {
    //    // If it does not already exist, try to create it
    //    vlist->Add(ident);
