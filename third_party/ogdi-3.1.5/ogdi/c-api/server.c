 ...
 *
 * $Log: server.c,v $
 * Revision 1.2  2006/06/05 14:24:42  syarrow
 * Update to GDAL, OGDI, PROJ, VTK, Xerces, Geotrans to be built with VC8.  All DLL's now use the DLL version of the runtime library and all debug versions of these libraries have debug information in them.
 * Fixed a few memory leaks.
 *
 * Revision 1.1  2005/07/20 19:26:31  syarrow
...
ECS_CVSID("$Id: server.c,v 1.2 2006/06/05 14:24:42 syarrow Exp $");
