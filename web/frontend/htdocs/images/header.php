  ...
  <div id="header-wrapper">
    <div class="contents">
      <div id="header">
        ...
        <div id="search">
          <form action="/Pyxis/www/search-results.php" id="cse-search-box">
            <div>
      ...
      <ul id="nav">
        ...
        <li <?php if ($thisPage=="products") echo " class=\"current\" "; ?>><a class="nolink" href="#">Products</a>
          <ul>
            ...
            <li><a <?php if ($thissubPage=="streamserver") echo " class=\"currentsubpage\" "; ?> href="geoweb-streamserver.php">GeoWeb StreamServer<span class="sup">TM</span></a></li>
        ...
        <li <?php if ($thisPage=="technology") echo " class=\"current\" "; ?>><a class="nolink" href="#">Technology</a>
          <ul>
              <li><a <?php if ($thissubPage=="derm") echo " class=\"currentsubpage\" "; ?> href="derm.php">DERM<span class="sup">TM</span></a></li>
              <li><a <?php if ($thissubPage=="pipe") echo " class=\"currentsubpage\" "; ?> href="pipe.php">PIPE<span class="sup">TM</span></a></li>
              <li><a <?php if ($thissubPage=="pyxnet") echo " class=\"currentsubpage\" "; ?> href="pyxnet.php">PyxNet<span class="sup">TM</span></a></li> 
          </ul>
        </li>
